...
function Tile(x, y,type) {
	...
	if (tile == null) {
		(function() {
			...
			Tile.BLANK.src = "memoria-animais/img/hidden.png";
			...
			Tile.IM0.src = "memoria-animais/img/papagaio.png";
			
			// IM1
			_ctx.fillStyle = "#cce6ff";
			_ctx.fillRect(0, 0, 160, 160);
			Tile.IM1 = new Image(160,160);
			Tile.IM1.src =  "memoria-animais/img/aguia.png";

			// IM2
			_ctx.fillStyle = "#cce6ff";
			_ctx.fillRect(0, 0, 160, 160);
			Tile.IM2 = new Image(100,100);
			Tile.IM2.src = "memoria-animais/img/animal.png";
			...
			Tile.IM3.src = "memoria-animais/img/avestruz.png";
			...
			Tile.IM4.src = "memoria-animais/img/cabra.png";
			...
			Tile.IM5.src ="memoria-animais/img/cao.png";
			...
			Tile.IM6.src = "memoria-animais/img/cavalo1.png";
			...
			Tile.IM7.src ="memoria-animais/img/cavalo2.png";
			...
			Tile.IM8.src = "memoria-animais/img/chita.png";
			...
			Tile.IM9.src = "memoria-animais/img/cisne.png";
			...
			Tile.IM10.src = "memoria-animais/img/gato.png";
			...
			Tile.IM11.src = "memoria-animais/img/girafa.png";
			...
			Tile.IM12.src = "memoria-animais/img/gorila.png";
			...
			Tile.IM13.src = "memoria-animais/img/insecto.png";
			...
			Tile.IM14.src = "memoria-animais/img/lama.png";
			...
			Tile.IM15.src = "memoria-animais/img/leao-marinho.png";
			...
			Tile.IM16.src = "memoria-animais/img/mocho.png";
			...
			Tile.IM17.src = "memoria-animais/img/patos.png";
			...
			Tile.IM18.src = "memoria-animais/img/raposa.png";
			...
			Tile.IM19.src = "memoria-animais/img/suricata.png";
			
			// IM20
			_ctx.fillStyle = "#cce6ff";
			_ctx.fillRect(0, 0, 150, 150);
			Tile.IM20 = new Image(160,160);
			Tile.IM20.src = "memoria-animais/img/tartaruga.png";
			
			// IM21
			_ctx.fillStyle = "#cce6ff";
			_ctx.fillRect(0, 0, 150, 150);
			Tile.IM21 = new Image(160,160);
			Tile.IM21.src = "memoria-animais/img/tigre.png";
			...
			Tile.IM23.src = "memoria-animais/img/veado.png";
...
function Logo() {
	...
	(function() {
		...
		logo = new Image();
		logo.src = "memoria-animais/img/logo.png";
